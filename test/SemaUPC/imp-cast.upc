...
void f1(shared struct incomplete1 * arg); // expected-note{{}} // expected-note{{}} // expected-note{{}}
void f2(shared struct incomplete2 * arg); // expected-note{{}} // expected-note{{}} // expected-note{{}}
void f3(shared struct complete1 * arg); // expected-note{{}} // expected-note{{}} // expected-note{{}}
void f4(shared int * arg); // expected-note{{}} // expected-note{{}} // expected-note{{}} // expected-note{{}}
void f5(shared [1] int * arg); // expected-note{{}}
void f6(shared [2] int * arg); // expected-note{{}} // expected-note{{}}
void f7(struct incomplete1 * arg); // expected-note{{}} // expected-note{{}}
void f8(int * arg); // expected-note{{}} // expected-note{{}}
void f9(shared [2] struct incomplete1 * arg); // expected-note{{}}
void f10(shared [2] struct complete1 * arg);  // expected-note{{}}
void f11(shared struct complete2 * arg); // expected-note{{}}
void f12(shared [2] struct complete2 * arg);  // expected-note{{}}
